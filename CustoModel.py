...
hidden1_w1 = tf.nn.sigmoid(tf.reduce_sum(tf.matmul(X1, W_hidden_1), W_hidden_1))
hidden1_w2 = tf.nn.sigmoid(tf.reduce_sum(tf.matmul(X2, W_hidden_2), W_hidden_2))
...
with tf.Session() as sess:
	...
	print(sess.run(tf.global_variables_initializer()))
	writer.close()
>>>>>>> e790996f1ddc9e48bc219d833093cf9b630e833b
